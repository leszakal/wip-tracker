...
class ProjectDetail extends StatefulWidget {
  final int projectId;
  final bool reload;
  const ProjectDetail({super.key, required this.projectId, this.reload = false});
...
class _ProjectDetailState extends State<ProjectDetail> {
  ...
  @override
  void didUpdateWidget(covariant ProjectDetail oldWidget) {
    ...
    return PopScope(
      ...
      onPopInvokedWithResult: (didPop, result) {
        if (widget.reload == true) {
          didPop = false;
          // prevents error about setState() being called during build
